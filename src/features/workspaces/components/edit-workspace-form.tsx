...
export const EditWorkspaceForm = ({
    ...
    const fullIviteLink = `${window.location.origin}/workspaces/${initialValues.$id}/join/${initialValues.inviteCode}`;

    const handleCopyInviteLink = () => {
        navigator.clipboard
            .writeText(fullIviteLink)
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="mt-4">
                            <div className="flex items-center gap-x-2">
                                <Input disabled value={fullIviteLink}></Input>
                                <Button
                                    className="size-12"
